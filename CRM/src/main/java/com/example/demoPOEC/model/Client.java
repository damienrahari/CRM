...
public class Client {
	...
	public Client(String company_name, String first_name, String last_name, String email, String phone, String address,
	...
	public String toString() {
		return "Client [id=" + id + ", company_name=" + company_name + ", first_name=" + first_name + ", last_name="
